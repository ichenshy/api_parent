...
//        interfaceInfoQuery.setDescription(null);
    ...
    public BaseResponse<Boolean> onlineInterfaceInfo(@RequestBody IdRequest idRequest) {
        ...
        com.chen.apiclientsdk.model.User user = new com.chen.apiclientsdk.model.User();
     ...
     * 测试调用
     *
     * @param interfaceInfoInvokeRequest id请求
     * @return {@code BaseResponse<Boolean>}
     */
    @PostMapping("/invoke")
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        // 转换成JSON
        Gson gson = new Gson();
        com.chen.apiclientsdk.model.User user = gson.fromJson(userRequestParam, com.chen.apiclientsdk.model.User.class);
        // 调用接口并获取返回值
